...
export default function Hero() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-32">
      ...
      <div className="absolute inset-0 lic-grid" />
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="relative shrink-0 w-full lg:w-auto">
              <div className="grid grid-cols-3 gap-2 lg:gap-6 max-w-xs mx-auto lg:max-w-none">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="relative size-16 lg:size-24 rounded-full bg-linear-to-br from-indigo-600 to-blue-600 shadow-lg flex items-center justify-center animate-pulse">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div
                    className="relative size-16 lg:size-24 rounded-full bg-linear-to-br from-blue-600 to-cyan-600 shadow-lg flex items-center justify-center animate-pulse"
                ...
                <div className="flex flex-col items-center gap-2">
                  <div
                    className="relative size-16 lg:size-24 rounded-full bg-linear-to-br from-cyan-600 to-teal-600 shadow-lg flex items-center justify-center animate-pulse"
            ...
            <div className="flex flex-col items-center gap-4 my-6 lg:my-0">
              ...
              <div className="flex flex-col items-center gap-2 lg:hidden">
                <ArrowDown className="size-6 text-indigo-600 dark:text-indigo-400 animate-bounce" />
              </div>

              {/* Desktop: Horizontal arrows pointing right */}
              <div className="hidden lg:flex lg:flex-col items-center gap-2">
                <ArrowRight className="size-10 text-indigo-600 dark:text-indigo-400 animate-pulse" />
                <ArrowRight
                  className="size-10 text-blue-600 dark:text-blue-400 animate-pulse"
                  style={{ animationDelay: "0.3s" }}
                />
                <ArrowRight
                  className="size-10 text-cyan-600 dark:text-cyan-400 animate-pulse"
                  style={{ animationDelay: "0.6s" }}
                />
              </div>

              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-indigo-700 to-cyan-600 shadow-lg">
            ...
            <div className="flex-1 w-full">
              <div className="rounded-xl border-2 border-indigo-600/80 dark:border-indigo-500 bg-white dark:bg-gray-900 shadow-2xl overflow-hidden">
                {/* Newsletter header */}
                <div className="bg-linear-to-r from-indigo-700 to-cyan-600 px-6 py-4">
